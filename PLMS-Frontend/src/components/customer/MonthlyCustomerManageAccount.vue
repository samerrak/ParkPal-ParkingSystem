  ...
  <div class="customerpage">
    ...
    <nav class="site-header sticky-top py-1">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block"  @click="Reload">Account</a>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="form-group" >
        <form id="form-update">
          ...
          <button id="update" type="submit" v-bind:disabled="allFields" @click="updateAcc" class="btn btn-primary">Update</button>
  ...
  methods: {
    ...
    async updateAcc() { // Method to update accounts
      ...
      axiosClient.put("/customer/update", request)
        ...
        .catch((err) => {
          this.errorMsg = `Failed to update: ${err.response.data}`
          alert(this.errorMsg)
        })
